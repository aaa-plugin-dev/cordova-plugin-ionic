...
var DeployClass = /** @class */ (function () {
    ...
    DeployClass.prototype.downloadUpdate = function (cancelToken, progress) {
        return __awaiter(this, void 0, void 0, function () {
            var deploy;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        deploy = _a.sent();
                        return [2 /*return*/, deploy.downloadUpdate(cancelToken, progress)];
                }
            });
        });
    };
    DeployClass.prototype.extractUpdate = function (cancelToken, progress) {
        return __awaiter(this, void 0, void 0, function () {
            var deploy;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        deploy = _a.sent();
                        return [2 /*return*/, deploy.extractUpdate(cancelToken, progress)];
                }
            });
        });
    };
    ...
    DeployClass.prototype.resetToBundle = function () {
        return __awaiter(this, void 0, void 0, function () {
            var deploy;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        deploy = _a.sent();
                        return [2 /*return*/, deploy.resetToBundle()];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        deploy = _a.sent();
                        return [2 /*return*/, deploy.showErrorAlert()];
                }
            });
        });
    };
    DeployClass.prototype.sync = function (options, cancelToken, progress) {
        return __awaiter(this, void 0, void 0, function () {
            var deploy;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        deploy = _a.sent();
                        return [2 /*return*/, deploy.sync(options, cancelToken, progress)];
                }
            });
        });
    };
