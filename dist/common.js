...
var IonicDeployImpl = /** @class */ (function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 3:
                        ...
                        if (!(checkDeviceResp.available &&
                            checkDeviceResp.url &&
                            checkDeviceResp.snapshot)) return [3 /*break*/, 5];
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        if (!(prefs.availableUpdate &&
                            prefs.availableUpdate.state === UpdateState.Available)) return [3 /*break*/, 13];
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.asyncPoolDownloads(concurrent, downloads, function (entry) { return __awaiter(_this, void 0, void 0, function () {
                                var maxTries, i, success, error, err_2;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
    ...
    IonicDeployImpl.prototype._diffManifests = function (newManifest, versionId) {
        return __awaiter(this, void 0, void 0, function () {
            var snapshotManifest, err_3, snapManifestStrings_1, differences;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        snapshotManifest = [];
                    ...
                    case 3:
                        err_3 = _a.sent();
                        console.log("Deploy => snapshotManifest error", err_3);
                        snapshotManifest = [];
                        return [3 /*break*/, 4];
                    case 4:
                        try {
                            console.log("xxxx => snapManifestStrings length", snapshotManifest.length);
                            snapManifestStrings_1 = snapshotManifest.map(function (entry) {
                                return JSON.stringify(entry);
                            });
                            console.log("xxxx => newManifest length", newManifest.length);
                            differences = newManifest.filter(function (entry) {
                                return entry.href === "assets/version.txt" ||
                                    (snapManifestStrings_1.indexOf(JSON.stringify(entry)) === -1 &&
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        prefs = this._savedPreferences;
                        if (!(prefs.availableUpdate &&
                            prefs.availableUpdate.state === UpdateState.Ready)) return [3 /*break*/, 2];
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        if (!(prefs.currentVersionForAppId === "5fc6b2fe")) return [3 /*break*/, 4];
                        return [4 /*yield*/, this.cleanReferenceDownload()];
                    case 3:
                        _b.sent();
                        return [3 /*break*/, 6];
                    case 4: return [4 /*yield*/, this.cleanAcgOrMwgDownload()];
                    case 5:
                        _b.sent();
                        _b.label = 6;
    ...
    IonicDeployImpl.prototype.cleanReferenceDownload = function () {
        return __awaiter(this, void 0, void 0, function () {
            var prefs, versionId;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        console.log("Deploy => Update " + prefs.currentVersionId + " was built for different binary version removing update from device" +
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, this._fileManager.copyFile("APPLICATION", Path.join(bundledAppDir, "cordova.js"), Path.join(snapshotDirectory, "cordova.js"))];
                    case 5:
                        _a.sent();
    ...
    IonicDeployImpl.prototype.parseManifestFile = function (dir) {
        return __awaiter(this, void 0, void 0, function () {
            var fileContents, filePath, err_4, manifest;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        fileContents = "[]";
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this._fileManager.getFileWithPlatform(filePath, this.appInfo.platform)];
                    case 2:
                        fileContents = _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
                        err_4 = _a.sent();
                        console.error("Deploy => Get pro-manifest file content: " + err_4);
                        return [3 /*break*/, 4];
                    case 4:
                        try {
    ...
    IonicDeployImpl.prototype.getAvailableVersions = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, Object.keys(updates).map(function (k) {
                        return _this._convertToSnapshotInfo(updates[k]);
                    })];
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        ...
                        _a.label = 6;
                    case 6:
                        if (!(prefs.availableUpdate.state === UpdateState.Ready &&
                            updateMethod === UpdateMethod.AUTO)) return [3 /*break*/, 8];
                        return [4 /*yield*/, this.reloadApp()];
                    case 7:
                        _a.sent();
                        _a.label = 8;
...
var FileManager = /** @class */ (function () {
    ...
    FileManager.prototype.copyFile = function (directory, fromFile, toFile) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        cordova.exec(resolve, reject, "IonicCordovaCommon", "copyFile", [
                            { directory: directory, fromFile: fromFile, toFile: toFile },
                        ]);
                    }).catch(function (error) {
                        return console.log("Deploy => Error copying file " + fromFile + ": " + error);
                    })];
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        ...
                        return console.log("Deploy => Error deleting file " + path + ": " + error);
                    })];
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        resolveLocalFileSystemURL(path, function (entry) {
                            return entry.isDirectory ? resolve(entry) : reject();
    ...
    FileManager.prototype.getFileWithPlatform = function (fullPath, platform) {
        return __awaiter(this, void 0, void 0, function () {
            var normalizedURL, prefix, req;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
